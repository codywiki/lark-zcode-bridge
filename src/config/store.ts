 ...
 * `~/.lark-zcode-bridge/secrets-getter` (always user-owned, never a symlink) so
...
export async function ensureSecretsGetterWrapper(
  ...
  if (platform === 'win32') {
    ...
    const content =
      `@echo off\r\n` +
      `rem Auto-generated by lark-zcode-bridge. Do not edit.\r\n` +
      `set "LARK_ZCODE_BRIDGE_HOME=${rootDir.replace(/"/g, '""')}"\r\n` +
  ...
  const content =
    `#!/bin/sh\n` +
    `# Auto-generated by lark-zcode-bridge. Do not edit.\n` +
    `# Forwards exec-provider requests to: node bridge secrets get\n` +
    `LARK_ZCODE_BRIDGE_HOME=${sq(rootDir)} exec ${sq(node)} ${sq(bridgeEntry)} secrets get "$@"\n`;
