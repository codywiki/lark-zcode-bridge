...
/**
 * Resolve the active cwd. ZCode runs with full-permission yolo by default, so
 * no profile-root authorization is enforced; the bridge-level access control
 * (allowedUsers / allowedChats) gates who can run at all.
 */
